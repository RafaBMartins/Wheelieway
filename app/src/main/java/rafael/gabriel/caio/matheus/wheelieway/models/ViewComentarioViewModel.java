...
public class ViewComentarioViewModel extends AndroidViewModel {

    public ViewComentarioViewModel(@NonNull Application application) {
        super(application);
    }
     ...
     */
    public LiveData<ComentarioItem> getComenatriosDetailLD(String pid) {

        // Cria um container do tipo MutableLiveData (um LiveData que pode ter seu conteúdo alterado).
        MutableLiveData<ComentarioItem> comentariosDetailLD = new MutableLiveData<>();
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                ComentarioItem c = wheelieWayRepository.loadComentariosDetail(pid);

                // Aqui postamos o resultado da operação dentro do LiveData. Quando fazemos isso,
                // quem estiver observando o LiveData será avisado de que o resultado está disponível.
                comentariosDetailLD.postValue(c);
            }
        });

        return comentariosDetailLD;
    }
}